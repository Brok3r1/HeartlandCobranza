...
class AdministratorsController extends AppController
{
    ...
    {
        $administrators = $this->Administrators->find('all')->contain(['Users'])->where(['Users.credential_id'=>2])->toArray();
    ...
    {
        $administrator = $this->Administrators->get($id, contain: ['Users']);
    ...
    public function add()
    {
        ...
        $users = $this->Administrators->Users->find('list', limit: 200)->all();
    ...
    public function editusr(){
        ...
        if ($this->request->is(['patch', 'post', 'put'])) {
            ...
            $id = $this->request->getData('id_administrator');
            $administrator = $this->Administrators->get($id);
    ...
    public function recoverypass($id=null){
        ...
        if($salvado){
            ...
            if($salvado2){
                ...
                return $this->redirect(['action' => 'indexa']);
            }
        }
        else{
            $this->Flash->error(__('No se pudo regenerar tu password. Por favor, intenta de nuevo.'));
