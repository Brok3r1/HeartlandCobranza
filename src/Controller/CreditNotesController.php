...
class CreditNotesController extends AppController
{
    ...
    {
        $creditNote = $this->CreditNotes->get($id, contain: ['CreditNoteXmls', 'CreditNoteConcepts', 'CreditNoteRelations']);
    ...
    public function add()
    {
        ...
        $creditNoteXmls = $this->CreditNotes->CreditNoteXmls->find('list', limit: 200)->all();
        $this->set(compact('creditNote', 'creditNoteXmls'));
    }
