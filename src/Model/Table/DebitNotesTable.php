 ...
 * DebitNotes Model
 *
 * @property \App\Model\Table\DebitNoteXmlsTable&\Cake\ORM\Association\BelongsTo $DebitNoteXmls
 * @property \App\Model\Table\DebitNoteConceptsTable&\Cake\ORM\Association\HasMany $DebitNoteConcepts
 * @property \App\Model\Table\DebitNoteRelationsTable&\Cake\ORM\Association\HasMany $DebitNoteRelations
 *
...
class DebitNotesTable extends Table
{
    ...
    public function initialize(array $config): void
    {
        ...
        $this->setDisplayField('id_debit_note');
        $this->setPrimaryKey('id_debit_note');

        $this->addBehavior('Timestamp');

        $this->belongsTo('DebitNoteXmls', [
            'foreignKey' => 'debit_note_xml_id',
        ]);
        $this->hasMany('DebitNoteConcepts', [
            'foreignKey' => 'debit_note_id',
        ]);
        $this->hasMany('DebitNoteRelations', [
            'foreignKey' => 'debit_note_id',
        ]);
    }
    ...
    {
        $validator
            ->integer('debit_note_xml_id')
            ->allowEmptyString('debit_note_xml_id');
    ...
    {
        $rules->add($rules->isUnique(['id_debit_note']), ['errorField' => 'id_debit_note']);
        $rules->add($rules->existsIn(['debit_note_xml_id'], 'DebitNoteXmls'), ['errorField' => 'debit_note_xml_id']);
