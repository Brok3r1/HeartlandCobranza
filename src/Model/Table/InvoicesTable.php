 ...
 * Invoices Model
 *
 * @property \App\Model\Table\InvoiceXmlsTable&\Cake\ORM\Association\BelongsTo $InvoiceXmls
 ...
 * @property \App\Model\Table\InvoiceConceptsTable&\Cake\ORM\Association\HasMany $InvoiceConcepts
 *
...
class InvoicesTable extends Table
{
    ...
    public function initialize(array $config): void
    {
        ...
        $this->setDisplayField('id_invoice');
        $this->setPrimaryKey('id_invoice');

        $this->addBehavior('Timestamp');

        $this->belongsTo('InvoiceXmls', [
    ...
    {
        $validator
            ->integer('invoice_xml_id')
            ->allowEmptyString('invoice_xml_id');
    ...
    {
        $rules->add($rules->isUnique(['id_invoice']), ['errorField' => 'id_invoice']);
        $rules->add($rules->existsIn(['invoice_xml_id'], 'InvoiceXmls'), ['errorField' => 'invoice_xml_id']);
