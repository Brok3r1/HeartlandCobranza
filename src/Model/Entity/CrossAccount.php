 ...
 * CrossAccount Entity
 *
 * @property int $id_cross_account
 * @property int|null $cross_account_xml_id
 ...
 *
 * @property \App\Model\Entity\CrossAccountXml $cross_account_xml
 * @property \App\Model\Entity\CrossAccountRelation[] $cross_account_relations
 */
class CrossAccount extends Entity
{
    /**
