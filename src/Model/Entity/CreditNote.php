 ...
 * CreditNote Entity
 *
 * @property int $id_credit_note
 * @property int|null $credit_note_xml_id
 ...
 *
 * @property \App\Model\Entity\CreditNoteXml $credit_note_xml
 * @property \App\Model\Entity\CreditNoteConcept[] $credit_note_concepts
...
class CreditNote extends Entity
{
    ...
    protected array $_accessible = [
        ...
        'created' => true,
        'modified' => true,
        'credit_note_xml' => true,
        'credit_note_concepts' => true,
