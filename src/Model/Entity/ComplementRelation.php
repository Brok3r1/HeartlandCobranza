...
/**
 * ComplementRelation Entity
 *
 * @property int $id_complement_relation
 * @property int|null $invoice_id
 * @property int|null $complement_id
 ...
 * @property \App\Model\Entity\Complement $complement
 */
class ComplementRelation extends Entity
{
    /**
