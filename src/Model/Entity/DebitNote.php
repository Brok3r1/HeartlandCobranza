 ...
 * DebitNote Entity
 *
 * @property int $id_debit_note
 * @property int|null $debit_note_xml_id
 ...
 *
 * @property \App\Model\Entity\DebitNoteXml $debit_note_xml
 * @property \App\Model\Entity\DebitNoteConcept[] $debit_note_concepts
