 ...
 * @var string[]|\Cake\Collection\CollectionInterface $crossAccountXmls
 */
?>
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                ...
                ['confirm' => __('Are you sure you want to delete # {0}?', $crossAccount->id_cross_account), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column column-80">
        <div class="crossAccounts form content">
            ...
            <fieldset>
                <legend><?= __('Edit Cross Account') ?></legend>
                <?php
