 ...
 * @var string[]|\Cake\Collection\CollectionInterface $debitNoteXmls
 */
?>
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                ...
                ['confirm' => __('Are you sure you want to delete # {0}?', $debitNote->id_debit_note), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column column-80">
        <div class="debitNotes form content">
            ...
            <fieldset>
                ...
                <?php
                    echo $this->Form->control('debit_note_xml_id', ['options' => $debitNoteXmls, 'empty' => true]);
