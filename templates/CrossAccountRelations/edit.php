 ...
 * @var string[]|\Cake\Collection\CollectionInterface $crossAccounts
 */
?>
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                ...
                ['confirm' => __('Are you sure you want to delete # {0}?', $crossAccountRelation->id_cross_account_relation), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column column-80">
        <div class="crossAccountRelations form content">
            ...
            <fieldset>
                <legend><?= __('Edit Cross Account Relation') ?></legend>
                <?php
