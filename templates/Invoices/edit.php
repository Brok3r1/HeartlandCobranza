 ...
 * @var string[]|\Cake\Collection\CollectionInterface $invoiceXmls
 */
?>
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                ...
                ['confirm' => __('Are you sure you want to delete # {0}?', $invoice->id_invoice), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column column-80">
        <div class="invoices form content">
            ...
            <fieldset>
                ...
                <?php
                    echo $this->Form->control('invoice_xml_id', ['options' => $invoiceXmls, 'empty' => true]);
